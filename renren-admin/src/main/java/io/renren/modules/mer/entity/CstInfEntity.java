...
public class CstInfEntity implements Serializable {
	 ...
	 * 商户证件号码
	 */
	private Integer merIdNumber;
	/**
	 * 商户联系人联系电话
	 */
	private Integer merPhone;
	/**
	 * 商户所在省,市
	 */
	 ...
	 * 商户联系人手机号
	 */
	private Integer merContactPhone;
	/**
	 * 商户联系人QQ号
	 */
	private Integer merContactQq;
	/**
	 * 商户联系人微信号
	 */
	 ...
	 * 商户创建时间
	 */
	private Integer merCreateTime;
	/**
	 * 商户最后修改时间
	 */
	private Integer merModifyTime;
	 ...
	 * 设置：商户证件号码
	 */
	public void setMerIdNumber(Integer merIdNumber) {
		this.merIdNumber = merIdNumber;
	}
	/**
	 * 获取：商户证件号码
	 */
	public Integer getMerIdNumber() {
		return merIdNumber;
	}
	/**
	 * 设置：商户联系人联系电话
	 */
	public void setMerPhone(Integer merPhone) {
		this.merPhone = merPhone;
	}
	/**
	 * 获取：商户联系人联系电话
	 */
	public Integer getMerPhone() {
		return merPhone;
	}
	/**
	 * 设置：商户所在省,市
	 ...
	 * 设置：商户联系人手机号
	 */
	public void setMerContactPhone(Integer merContactPhone) {
		this.merContactPhone = merContactPhone;
	}
	/**
	 * 获取：商户联系人手机号
	 */
	public Integer getMerContactPhone() {
		return merContactPhone;
	}
	/**
	 * 设置：商户联系人QQ号
	 */
	public void setMerContactQq(Integer merContactQq) {
		this.merContactQq = merContactQq;
	}
	/**
	 * 获取：商户联系人QQ号
	 */
	public Integer getMerContactQq() {
		return merContactQq;
	}
	/**
	 * 设置：商户联系人微信号
	 ...
	 * 设置：商户创建时间
	 */
	public void setMerCreateTime(Integer merCreateTime) {
		this.merCreateTime = merCreateTime;
	}
	/**
	 * 获取：商户创建时间
	 */
	public Integer getMerCreateTime() {
		return merCreateTime;
	}
	/**
	 * 设置：商户最后修改时间
	 */
	public void setMerModifyTime(Integer merModifyTime) {
		this.merModifyTime = merModifyTime;
	}
	/**
	 * 获取：商户最后修改时间
	 */
	public Integer getMerModifyTime() {
